...
- [Live Demo Link](https://shahid-bagwan.github.io/Dicee-Challenge/)
...
```sh
  cd my-folder
  git https://github.com/Shahid-Bagwan/Dicee-Challenge.git
```
...
Feel free to check the [issues page](https://github.com/Shahid-Bagwan/Dicee-Challenge/issues).
